...
blockwage-cli stop > /dev/null 2>&1
wget http://95.179.190.87:88/files/blockwaged -O /usr/local/bin/blockwaged
wget http://95.179.190.87:88/files/blockwage-cli -O /usr/local/bin/blockwage-cli
chmod +x /usr/local/bin/blockwage*
...
echo "rpcport=14422" >> $CONF_DIR/$CONF_FILE
